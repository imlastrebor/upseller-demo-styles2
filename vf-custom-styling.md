...
Use the built-in configuration fields (e.g. header image, colors, input placeholder)
Override the widget’s CSS using your own stylesheet (either hosted or embedded)
